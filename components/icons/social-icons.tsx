...
// All use currentColor so they inherit the surrounding text color. Shared by the public
// "Follow this place" card and the operator's social-link inputs so the marks never drift.
